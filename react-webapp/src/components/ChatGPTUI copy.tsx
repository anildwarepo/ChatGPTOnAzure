...
import ChatHistoryIconSvg from '../assets/chathistory.svg';
...
export const ChatGPTUI = (props: any) => {
    ...
    return (
                ...
                <Container fluid >
                    <Row>
                        <Col md={3} className="position-fixed h-100 bg-dark" border="primary">
                        {/* This is the fixed panel on the left */}
                        <div className="messages-history">
                                ...
                                <Accordion className="chat-settings" defaultActiveKey="0">
                                    ...
                                    <Accordion.Item eventKey="1">
                                        <Accordion.Header>
                                            <img className="icon" src={ChatHistoryIconSvg} alt="icon" /><span>Chat History</span>
                                        </Accordion.Header>
                                        <Accordion.Body>
                                        
                                            
                                            <ul className="prev-chat-items">
                                                    {prevChatHistory.map((chat, index) => {
                                                        if (chat.userType === "user") {
                                                        return (
                                                            <li onClick={() => setChatHistory(prevChatHistory)} key={index} className="chat-message">
                                                            {chat.userMessage}
                                                            </li>
                                                        );
                                                        } else {
                        ...
                        <Col md={9} className="ml-md-auto">
                        {/* This is the main content area */}
                            <div className="chat-block flex-wrap">
